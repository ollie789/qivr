...
DECLARE
  ...
  v_provider_id UUID;
BEGIN
  SELECT id, tenant_id INTO v_patient_id, v_tenant_id FROM patients WHERE email = 'patient1762923257212@example.com' LIMIT 1;
  ...
  IF v_patient_id IS NOT NULL THEN
    ...
    RAISE NOTICE 'Seeded % appointments for patient %', 3, v_patient_id;
  ELSE
