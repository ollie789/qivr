...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddQivrServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<ITenantService, EnhancedTenantService>(); // SaaS-enabled tenant service
...
public interface IEvaluationService
{
    ...
    Task<EvaluationDetailDto?> GetEvaluationDetailAsync(Guid id, CancellationToken cancellationToken = default);
