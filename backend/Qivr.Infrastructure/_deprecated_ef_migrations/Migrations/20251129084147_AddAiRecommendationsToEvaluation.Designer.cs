...
namespace Qivr.Infrastructure.Migrations
{
    ...
    [Migration("20251129084147_AddAiRecommendationsToEvaluation")]
    partial class AddAiRecommendationsToEvaluation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Qivr.Core.Entities.DailyCheckIn", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");

                    b.Property<bool>("ContinuedStreak")
                        .HasColumnType("boolean")
                        .HasColumnName("continued_streak");

                    b.Property<DateTime>("Date")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("date");

                    b.Property<int>("ExercisesAssigned")
                        .HasColumnType("integer")
                        .HasColumnName("exercises_assigned");

                    b.Property<int>("ExercisesCompleted")
                        .HasColumnType("integer")
                        .HasColumnName("exercises_completed");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_daily_check_in");

                    b.HasIndex("TreatmentPlanId")
                        .HasDatabaseName("ix_daily_check_in_treatment_plan_id");

                    b.ToTable("daily_check_in");
                });
            ...
            modelBuilder.Entity("Qivr.Core.Entities.TreatmentPlan", b =>
                {
                    ...
                    b.Property<List<TreatmentMilestone>>("Milestones")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.Property<List<TreatmentPhase>>("Phases")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.Property<TreatmentPlanPromConfig>("PromConfig")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<List<TreatmentSession>>("Sessions")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Qivr.Core.Entities.DailyCheckIn", b =>
                {
                    b.HasOne("Qivr.Core.Entities.TreatmentPlan", null)
                        .WithMany("CheckIns")
                        .HasForeignKey("TreatmentPlanId")
                        .HasConstraintName("fk_daily_check_in__treatment_plans_treatment_plan_id");
                });
