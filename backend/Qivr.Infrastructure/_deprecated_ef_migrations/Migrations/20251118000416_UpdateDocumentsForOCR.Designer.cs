...
namespace Qivr.Infrastructure.Migrations
{
    ...
    [Migration("20251118000416_UpdateDocumentsForOCR")]
    partial class UpdateDocumentsForOCR
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Qivr.Core.Entities.Document", b =>
                {
                    ...
                    b.Property<string>("ExtractedIdentifiers")
                        .HasColumnType("jsonb")
                        .HasColumnName("extracted_identifiers");
                    ...
                    b.HasIndex("AssignedTo")
                        .HasDatabaseName("ix_documents_assigned_to");
            ...
            modelBuilder.Entity("Qivr.Core.Entities.Document", b =>
                {
                    b.HasOne("Qivr.Core.Entities.User", "AssignedToUser")
                        ...
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_documents_users_assigned_to_user_id");
            ...
            modelBuilder.Entity("Qivr.Core.Entities.DocumentAuditLog", b =>
                {
                    ...
                    b.HasOne("Qivr.Core.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_document_audit_logs_users_user_id");
