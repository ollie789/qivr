...
namespace Qivr.Infrastructure._deprecated_ef_migrations.Migrations
{
    ...
    [Migration("20251209010547_AddPromInfrastructure")]
    partial class AddPromInfrastructure
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Qivr.Core.Entities.Appointment", b =>
                {
                    ...
                    b.HasIndex("ServiceTypeId")
                        .HasDatabaseName("ix_appointments_service_type_id");
            ...
            modelBuilder.Entity("Qivr.Core.Entities.PatientInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("EvaluationId")
                        .HasDatabaseName("ix_patient_invitations_evaluation_id");

                    b.HasIndex("Token")
                        .IsUnique();

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_patient_invitations_user_id");
                    ...
                    b.ToTable("patient_invitations", (string)null);
                });
            ...
            modelBuilder.Entity("Qivr.Core.Entities.ServiceType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("TenantId", "Specialty", "Name");
            ...
            modelBuilder.Entity("Qivr.Core.Entities.TreatmentProgressFeedback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<List<string>>("Barriers")
                        .HasColumnType("text[]")
                    ...
                    b.Property<string>("ExerciseComments")
                        .HasColumnType("text")
                        .HasColumnName("exercise_comments");

                    b.Property<int?>("ExerciseCompliance")
                        .HasColumnType("integer")
                        .HasColumnName("exercise_compliance");

                    b.Property<List<Guid>>("HelpfulExerciseIds")
                        .HasColumnType("uuid[]")
                        .HasColumnName("helpful_exercise_ids");

                    b.Property<int?>("OverallEffectivenessRating")
                        .HasColumnType("integer")
                        .HasColumnName("overall_effectiveness_rating");

                    b.Property<int?>("PainComparedToStart")
                        .HasColumnType("integer")
                        .HasColumnName("pain_compared_to_start");

                    b.Property<Guid>("PatientId")
                        .HasColumnType("uuid")
                        .HasColumnName("patient_id");

                    b.Property<List<Guid>>("ProblematicExerciseIds")
                        .HasColumnType("uuid[]")
                        .HasColumnName("problematic_exercise_ids");

                    b.Property<Guid>("PromInstanceId")
                        .HasColumnType("uuid")
                        .HasColumnName("prom_instance_id");

                    b.Property<int?>("SessionsCompletedThisWeek")
                        .HasColumnType("integer")
                        .HasColumnName("sessions_completed_this_week");
                    ...
                    b.Property<bool?>("WantsClinicianDiscussion")
                        .HasColumnType("boolean")
                        .HasColumnName("wants_clinician_discussion");

                    b.HasKey("Id")
                        .HasName("pk_treatment_progress_feedbacks");

                    b.HasIndex("PatientId")
                        .HasDatabaseName("ix_treatment_progress_feedbacks_patient_id");

                    b.HasIndex("PromInstanceId")
                        .HasDatabaseName("ix_treatment_progress_feedbacks_prom_instance_id");
            ...
            modelBuilder.Entity("Qivr.Core.Entities.Appointment", b =>
                {
                    ...
                    b.HasOne("Qivr.Core.Entities.ServiceType", "ServiceType")
                        .WithMany()
                        .HasForeignKey("ServiceTypeId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_appointments__service_types_service_type_id");
            ...
            modelBuilder.Entity("Qivr.Core.Entities.PatientInvitation", b =>
                {
                    b.HasOne("Qivr.Core.Entities.User", "CreatedByUser")
                        .WithMany()
                    ...
                    b.HasOne("Qivr.Core.Entities.Evaluation", "Evaluation")
                        ...
                        .HasForeignKey("EvaluationId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_patient_invitations_evaluations_evaluation_id");
                    ...
                    b.HasOne("Qivr.Core.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_patient_invitations__users_user_id1");
            ...
            modelBuilder.Entity("Qivr.Core.Entities.ServiceType", b =>
                {
                    b.HasOne("Qivr.Core.Entities.Tenant", "Tenant")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_service_types__tenants_tenant_id");
            ...
            modelBuilder.Entity("Qivr.Core.Entities.TreatmentProgressFeedback", b =>
                {
                    b.HasOne("Qivr.Core.Entities.User", "Patient")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_treatment_progress_feedbacks__users_patient_id");
                    ...
                    b.HasOne("Qivr.Core.Entities.PromInstance", "PromInstance")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_treatment_progress_feedbacks_prom_instances_prom_instance_id");
                    ...
                    b.HasOne("Qivr.Core.Entities.TreatmentPlan", "TreatmentPlan")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_treatment_progress_feedbacks_treatment_plans_treatment_plan~");
