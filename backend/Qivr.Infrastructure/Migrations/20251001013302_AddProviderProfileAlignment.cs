...
{
    /// <inheritdoc />
    public partial class AddProviderProfileAlignment : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Update existing appointments to set provider_profile_id based on provider_id
            migrationBuilder.Sql(@"
                ...
                WHERE a.provider_profile_id IS NULL
                  AND EXISTS (
                    SELECT 1 FROM providers p WHERE p.user_id = a.provider_id
                  )
            ");

            // Now make the column non-nullable with a default for new records
