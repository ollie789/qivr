...
namespace Qivr.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251201083403_AddResearchPartnerEntities")]
    partial class AddResearchPartnerEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Qivr.Core.Entities.PatientDeviceUsage", b =>
                {
                    ...
                    b.HasIndex("TreatmentPlanId")
                        .HasDatabaseName("ix_patient_device_usages_treatment_plan_id");
            ...
            modelBuilder.Entity("Qivr.Core.Entities.PatientDeviceUsage", b =>
                {
                    ...
                    b.HasOne("Qivr.Core.Entities.TreatmentPlan", "TreatmentPlan")
                        ...
                        .HasForeignKey("TreatmentPlanId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_patient_device_usages__treatment_plans_treatment_plan_id");
