...
const IntakeForm = lazy(() =>
  import("./pages/IntakeForm").then((m) => ({ default: m.IntakeForm })),
);
const Appointments = lazy(() => import("./pages/Appointments"));
const BookAppointment = lazy(() =>
  import("./pages/BookAppointment").then((m) => ({
    default: m.BookAppointment,
  })),
);
const RescheduleAppointment = lazy(() =>
  import("./pages/RescheduleAppointment").then((m) => ({
    default: m.RescheduleAppointment,
  })),
);
const PROMEnhanced = lazy(() => import("./pages/PROMEnhanced"));
const CompletePROM = lazy(() =>
  import("./pages/CompletePROM").then((m) => ({ default: m.CompletePROM })),
);
