                          ...
                          <Grid size={{ xs: 12, sm: 2 }}>
                            <Box display="flex" gap={0.5}>
                              <Chip
                                ...
                                size="small"
                                color={
                                  day.allowsTelehealth ? "primary" : "default"
                                }
                                variant={
                                  day.allowsTelehealth ? "filled" : "outlined"
                                }
                                onClick={() =>
                                  handleScheduleChange(
                                    index,
                              ...
                              <Chip
                                ...
                                size="small"
                                color={
                                  day.allowsInPerson ? "primary" : "default"
                                }
                                variant={
                                  day.allowsInPerson ? "filled" : "outlined"
                                }
                                onClick={() =>
                                  handleScheduleChange(
                                    index,
        ...
        <Grid container spacing={2} sx={{ mt: 1 }}>
          ...
          <Grid size={12}>
            <SelectField
              ...
              onChange={(value) =>
                setNewTimeOff({ ...newTimeOff, type: value })
              }
