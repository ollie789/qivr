...
export const chiefComplaintQuestion: Question = {
  name: "chiefComplaint",
  label: "What is the main reason for your visit today?",
  type: "textarea",
  required: true,
  placeholder:
    "Please describe your main concern or symptoms in your own words...",
  rows: 3,
};

export const chiefComplaintSection: QuestionSection = {
  id: "chief-complaint",
  title: "Main Concern",
  description: "Tell us why you're seeking care today.",
  questions: [chiefComplaintQuestion],
};
...
export const painStartOptions: SelectOption[] = [
  ...
  {
    value: "After specific activity or sport",
    label: "After specific activity or sport",
  },
...
export const hasImagingOptions: SelectOption[] = [
  { value: "", label: "Select..." },
  { value: "Yes", label: "Yes" },
  { value: "No", label: "No" },
...
export const imagingTimeframeOptions: SelectOption[] = [
...
export const imagingTypesOptions: CheckboxOption[] = [
...
export const hasImagingQuestion: Question = {
  name: "hasImaging",
  label: "Have you had any imaging done for this condition?",
  type: "select",
  options: hasImagingOptions,
};

export const imagingTimeframeQuestion: Question = {
  name: "imagingTimeframe",
  label: "How long ago was the imaging done?",
  type: "select",
  options: imagingTimeframeOptions,
  showWhen: { field: "hasImaging", value: "Yes" },
};

export const imagingTypesQuestion: Question = {
  name: "imagingTypes",
  label: "What type of imaging did you have?",
  type: "checkbox-group",
  options: imagingTypesOptions,
  showWhen: { field: "hasImaging", value: "Yes" },
};
...
export const currentTreatmentsOptions: CheckboxOption[] = [
  ...
  {
    value: "Injections (cortisone, etc.)",
    label: "Injections (cortisone, etc.)",
  },
  { value: "Prescription medication", label: "Prescription medication" },
  {
    value: "Over-the-counter medication",
...
export const medicationsOptions: CheckboxOption[] = [
  ...
  {
    value: "Prescription pain medication",
    label: "Prescription pain medication",
  },
  { value: "Muscle relaxants", label: "Muscle relaxants" },
  {
    value: "Anti-inflammatory prescription",
    label: "Anti-inflammatory prescription",
  },
  { value: "Topical pain relief", label: "Topical pain relief" },
  {
    value: "Supplements (glucosamine, etc.)",
    label: "Supplements (glucosamine, etc.)",
  },
  { value: "None", label: "None" },
];
...
export const redFlagsOptions: CheckboxOption[] = [
  ...
  {
    value: "Loss of bowel/bladder control",
    label: "Loss of bowel/bladder control",
  },
  {
    value: "Fever or unexplained weight loss",
    label: "Fever or unexplained weight loss",
  },
  { value: "Severe night pain", label: "Severe night pain" },
  {
    value: "Pain getting progressively worse",
    label: "Pain getting progressively worse",
  },
...
export const medicalHistorySection: QuestionSection = {
  ...
  questions: [
    painStartQuestion,
    hasImagingQuestion,
    imagingTimeframeQuestion,
    imagingTypesQuestion,
    {
      name: "prevOrtho",
...
export const goalsOptions: CheckboxOption[] = [
  ...
  {
    value: "Improve mobility and flexibility",
    label: "Improve mobility and flexibility",
  },
  {
    value: "Increase strength and stability",
    label: "Increase strength and stability",
  },
  { value: "Sleep better without pain", label: "Sleep better without pain" },
  {
    value: "Return to normal daily activities",
    label: "Return to normal daily activities",
  },
  {
    value: "Return to sports/recreational activities",
    label: "Return to sports/recreational activities",
  },
  {
    value: "Return to work or improve work function",
    label: "Return to work or improve work function",
  },
  { value: "Avoid surgery if possible", label: "Avoid surgery if possible" },
  {
    value: "Prepare for upcoming surgery",
    label: "Prepare for upcoming surgery",
  },
  {
    value: "Recover from recent surgery",
    label: "Recover from recent surgery",
  },
  { value: "Reduce medication use", label: "Reduce medication use" },
  {
    value: "Improve posture and alignment",
    label: "Improve posture and alignment",
  },
  {
    value: "Prevent condition from worsening",
    label: "Prevent condition from worsening",
  },
  {
    value: "Maintain independent living",
    label: "Maintain independent living",
  },
];
...
export const milestonesOptions: CheckboxOption[] = [
  ...
  {
    value: "Lift weights/strength train",
    label: "Lift weights/strength train",
  },
...
export const allCheckboxValues = {
  ...
  imagingTypes: imagingTypesOptions.map((o) => o.value),
