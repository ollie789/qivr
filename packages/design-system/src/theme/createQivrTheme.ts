 ...
 * Compact, information-dense typography for clinical apps
 * Uses smaller base sizes for better screen real estate
 */
const typography = {
  htmlFontSize: 16,
  ...
  // Compact headings - reduced sizes throughout
  h1: {
    fontSize: "clamp(1.5rem, 1.25rem + 1vw, 1.875rem)", // 24px → 30px (was 28→36)
    fontWeight: 700,
    lineHeight: 1.2,
  },
  h2: {
    fontSize: "clamp(1.25rem, 1.1rem + 0.75vw, 1.5rem)", // 20px → 24px (was 24→30)
    fontWeight: 700,
    lineHeight: 1.25,
  },
  h3: {
    fontSize: "clamp(1.125rem, 1rem + 0.5vw, 1.25rem)", // 18px → 20px (was 20→24)
    fontWeight: 700,
    lineHeight: 1.3,
  },
  h4: {
    fontSize: "clamp(1rem, 0.9rem + 0.4vw, 1.125rem)", // 16px → 18px (was 18→20)
    fontWeight: 600,
    lineHeight: 1.35,
  },
  h5: {
    fontSize: "0.9375rem", // 15px fixed (was 16→18)
    fontWeight: 600,
    lineHeight: 1.4,
  },
  h6: {
    fontSize: "0.875rem", // 14px fixed (was 15px)
    fontWeight: 600,
    lineHeight: 1.5,
  },

  subtitle1: {
    fontSize: "0.875rem", // 14px (was 15px)
    fontWeight: 500,
    lineHeight: 1.5,
  },
  subtitle2: {
  ...
  body1: {
    fontSize: "0.875rem", // 14px (was 15px) - main body text
    fontWeight: 400,
    lineHeight: 1.5,
  },
  body2: {
  ...
  caption: {
    fontSize: "0.6875rem", // 11px (was 12px) - smaller captions
    fontWeight: 400,
    lineHeight: 1.5,
  },

  overline: {
    fontSize: "0.625rem", // 10px (was 11px)
    fontWeight: 600,
 ...
 */
const shape = {
  borderRadius: 6, // Slightly tighter border radius (was 8)
};

/**
 * Spacing configuration
 * Reduced base unit for denser layouts (was 8px)
 */
const spacing = 7;
